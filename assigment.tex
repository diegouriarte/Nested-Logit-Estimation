...
\NormalTok{data_with_instruments }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(z1, z2, z3, z11, z22, z33) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{describe}\NormalTok{(}\DataTypeTok{skew =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{quant=}\KeywordTok{c}\NormalTok{(.}\DecValTok{25}\NormalTok{,.}\DecValTok{75}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{kable}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
