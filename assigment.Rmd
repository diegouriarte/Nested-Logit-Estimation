...
We are asked to collapse the data to the market level.The first 10 values of the collapsed dataset are showed. The complete dataset transformation can be found in the replication file which can be located in the following repository: <https://github.com/diegouriarte/Nested-Logit-Estimation>. 
